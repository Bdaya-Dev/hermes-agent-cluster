    ...
    def _loop():
        ...
        while True:
            ...
            if registered_id is not None:
                ...
                # steals_a_stale_holder). Checked BEFORE the unknown_node
                # branch: a replaced instance must not "re-join storm" its
                # way back over the live owner.
                ...
                if isinstance(hb, dict) and hb.get("status") == "unknown_node":
                    logger.warning(
